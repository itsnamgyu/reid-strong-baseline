# encoding: utf-8
"""
Data loader for MSMT17 (V1), based on dukemtmcreid.py
"""
...
class MSMT17(BaseImageDataset):
    ...
    def _download_data(self):
        if osp.exists(self.dataset_dir):
            ...
            raise RuntimeError("Namgyu) MSMT17 (V1) dataset does not exist in {}. I won't download for you. Sorry".format(self.dataset_dir))
